...
func CreateBook(c *fiber.Ctx) error {
	...
	logger.Info("Book created", zap.String("book_title", createdBook.Title))
...
func UpdateBook(c *fiber.Ctx) error {
	...
	logger := helpers.GetLogger()
	logger.Info("Book updated", zap.String("book_title", updatedBook.Title))
...
func DeleteBook(c *fiber.Ctx) error {
	...
	logger := helpers.GetLogger()
	logger.Info("Book deleted", zap.String("book_id", bookIDParam))
